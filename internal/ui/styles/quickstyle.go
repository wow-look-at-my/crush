...
func quickStyle(o quickStyleOpts) Styles {
	...
	s.Editor.PromptAcceptEditsIconFocused = lipgloss.NewStyle().MarginRight(1).Foreground(o.onPrimary).Background(o.success).Bold(true).SetString(" E ")
	s.Editor.PromptAcceptEditsIconBlurred = s.Editor.PromptAcceptEditsIconFocused.Foreground(o.bgBase).Background(o.fgMoreSubtle)
	s.Editor.PromptAcceptEditsDotsFocused = lipgloss.NewStyle().MarginRight(1).Foreground(o.success).SetString(":::")
	s.Editor.PromptAcceptEditsDotsBlurred = s.Editor.PromptAcceptEditsDotsFocused.Foreground(o.fgMoreSubtle)
